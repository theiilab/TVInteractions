...
//    };
    ...
    public final static String[] searchDummytitles = { // 250 movie titles
            "A Beautiful Mind", "A Clockwork Orange", "A Ghost Story", "A Silent Voice", "A Star is Born", "A Streetcar Named Desire", "Amadeus", "Amelie", "American Beauty", "American Hustle", "An Autumn Afternoon", "Apocalypse Now", "Arrival", "Astral Ascension", "Avatar", "Bohemian Rhapsody", "Bombshell", "Boy", "Braveheart", "Brokeback Mountain", "Call Me by Your Name", "Casablanca", "Castle in the Sky", "Celestial Cascade", "Crimson Peak", "Crouching Tiger Hidden Dragon", "Curse of the Golden Flower", "Dallas Buyers Club", "Dancer in the Dark", "Dangerous Liaisons", "Danton", "Dark Star", "Darling", "Day for Night", "Django Unchained", "Donnie Darko", "Dr Strangelove", "Drunken Master", "Dunkirk", "Eagle vs Shark", "Echoes of Eldoria", "ET the Extra-Terrestrial", "Facing the Giants", "Fairy", "Fantastic Mr Fox", "Far Out Man", "Farewell My Concubine", "Fear", "Feast of Love", "Fight Club", "Five Centimeters Per Second", "Ford v Ferrari", "Forrest Gump", "Foster", "Full Metal Jacket", "Full Metal Jacket", "Galactic Genesis", "Get Out", "Grave of the Fireflies", "Gravity", "Green Book", "Happy Together", "House of Flying Daggers", "Howls Moving Castle", "Hunt for the Wilderpeople", "In the Mood for Love", "Infinity Insight", "Inglourious Basterds", "Interstellar", "Ip Man", "Isle of Dogs", "Jaws", "Jurassic Park", "Keeping Mum", "Key West", "Kicked in the Head", "Kikis Delivery Service", "Killing Moon", "Killing Mr Griffin", "Kindergarten Cop", "King Kong", "King of California", "Kiss of Death", "Knives Out", "Knock Knock", "Lady Bird", "Lady of the Manor", "Land of Mine", "Late Spring", "Lawrence of Arabia", "Learn to Swim", "Leaving Neverland", "Life of Pi", "Lincoln", "Line Walker", "Little Miss Sunshine", "Little Women", "Lost in Translation", "Luminous Legacy", "Mad Max Fury Road", "Marie Antoinette", "Marriage Story", "Midnight in Paris", "Midnight Mirage", "Millennium Actress", "Mirage Manifest", "Moonlight", "Moonlight Kingdom", "Moonrise Kingdom", "My Neighbor Totoro", "Nancy", "National Treasure", "Nausicaa of the Valley of the Wind", "Navalny", "Nebula Nectar", "Nebula Nexus", "Nelly", "Nemesis", "Never Have I Ever", "No Country for Old Men", "No Looking Back", "North by Northwest", "October Sky", "Odyssey of the Echo", "Oldboy", "On the Waterfront", "Once Upon a Time in Hollywood", "One Flew Over the Cuckoos Nest", "Pacific Rim", "Pans Labyrinth", "Paprika", "Parasite", "Perfect Blue", "Platoon", "Ponyo", "Porco Rosso", "Princess Mononoke", "Pulp Fiction", "Qiu Jin", "Qu Yuan", "Quality Time", "Quantum Love", "Quantum Odyssey", "Quantum of Solace", "Quantum Quasar", "Quay", "Queen and Country", "Queen Bees", "Quincy", "Quiz Show", "Radiant Reminiscence", "Radiant Reverie", "Radio Flyer", "Radius", "Raging Bull", "Raiders of the Lost Ark", "Rain Man", "Raise the Red Lantern", "Ran", "Rashomon", "Reach for Me", "Ready Player One", "Rebel Without a Cause", "Red Joan", "Redeeming Love", "Reservoir Dogs", "Rushmore", "Sami Blood", "San Andreas", "Saving Private Ryan", "Scenes of the Crime", "Scenic Route", "Schindlers List", "Second Act", "Seeking Justice", "Selma", "Seven Samurai", "Shutter Island", "Silver Linings Playbook", "Slumdog Millionaire", "Solstice Symphony", "Somewhere", "Southland Tales", "Spartacus", "Spirited Away", "Star Wars A New Hope", "Stardust Sonata", "Stellar Serenity", "Summer Wars", "Sunset Boulevard", "Sunshine Cleaning", "Taxi Driver", "The Great Escape", "The Great Gatsby", "The Green Book", "The Green Mile", "The Hidden Fortress", "The Hurt Locker", "The Imitation Game", "The Irishman", "The Kings Speech", "The Last Samurai", "The Life Aquatic with Steve Zissou", "The Namesake", "The Patriot", "The Pianist", "The Post", "The Prestige", "The Princess Bride", "The Virgin Suicides", "The Wind Rises", "The Wizard of Oz", "Thor Ragnarok", "Three Billboards Outside Ebbing, Missouri", "Throne of Blood", "Titanic", "To Kill a Mockingbird", "To Live", "Tokyo Godfathers", "Tokyo Story", "Troy", "Twelve Angry Men", "Twelve Years a Slave", "V for Vendetta", "Valentines Day", "Valerian and the City of a Thousand Planets", "Valley of Love", "Vampire Diary", "Van Helsing", "Venom", "Vertigo", "Vesper", "Vessel", "Vice", "Viking", "Whisper of the Heart", "Whispers in the Shadows", "Wolf Children", "Year by the Sea", "Year One", "Yellow Rose", "Yes Day", "Yojimbo", "Yona", "Yosemite", "You Again", "You Are Here", "You People", "Young Adam", "Your Name"
    };
