...
//    public final static String[] searchDummytitles = { // 250 movie titles
...
//    };
    ...
    public final static String[] searchDummytitles = { // 250 movie titles
            "A Beautiful Mind", "A Clockwork Orange", "A Ghost Story", "A Silent Voice", "A Star is Born", "A Streetcar Named Desire", "Amadeus", "Amelie", "American Beauty", "American Hustle", "An Autumn Afternoon", "Apocalypse Now", "Arrival", "Astral Ascension", "Avatar", "Ben-Hur", "Birdman", "Black Panther", "Black Swan", "Blade II", "Blade Runner", "Blade Runner 2049", "Bohemian Rhapsody", "Bombshell", "Boy", "Braveheart", "Brokeback Mountain", "Call Me by Your Name", "Casablanca", "Castle in the Sky", "Celestial Cascade", "Celestial Cipher", "Chinatown", "Chungking Express", "Citizen Kane", "Crash", "Crimson Peak", "Crouching Tiger Hidden Dragon", "Curse of the Golden Flower", "Dallas Buyers Club", "Django Unchained", "Donnie Darko", "Dr. Strangelove", "Drunken Master", "Dunkirk", "Eagle vs Shark", "Echoes of Eldoria", "Echoes of Eternity", "Eclipse Enigma", "Enchanted Equinox", "Enigma Emporium", "ET the Extra-Terrestrial", "Fantastic Mr. Fox", "Farewell My Concubine", "Fight Club", "Five Centimeters Per Second", "Ford v Ferrari", "Forrest Gump", "Full Metal Jacket", "Galactic Genesis", "Get Out", "Gladiator", "Gone with the Wind", "Good Will Hunting", "Goodfellas", "Grave of the Fireflies", "Gravity", "Green Book", "Happy Together", "Hellboy", "Hellboy II The Golden Army", "Her", "Hero", "House of Flying Daggers", "Howls Moving Castle", "Hunt for the Wilderpeople", "In the Mood for Love", "Infinity Insight", "Inglourious Basterds", "Interstellar", "Ip Man", "Isle of Dogs", "Jaws", "Jojo Rabbit", "Joker", "Juno", "Jurassic Park", "Keeping Mum", "Kikis Delivery Service", "Killing Moon", "King Kong", "King of California", "Knives Out", "Lady Bird", "Late Spring", "Lawrence of Arabia", "Life of Pi", "Little Miss Sunshine", "Little Women", "Lost in Translation", "Luminous Legacy", "Mad Max Fury Road", "Marie Antoinette", "Marriage Story", "Midnight in Paris", "Midnight Mirage", "Millennium Actress", "Mirage Manifest", "Moonlight", "Moonlight Kingdom", "Moonrise Kingdom", "My Neighbor Totoro", "National Treasure", "Nausicaa of the Valley of the Wind", "Nebula Nectar", "Nebula Nexus", "No Country for Old Men", "North by Northwest", "October Sky", "Odyssey of the Echo", "Oldboy", "On the Waterfront", "Once Upon a Time in Hollywood", "One Flew Over the Cuckoos Nest", "Pacific Rim", "Pans Labyrinth", "Paprika", "Parasite", "Perfect Blue", "Platoon", "Ponyo", "Porco Rosso", "Princess Mononoke", "Pulp Fiction", "Quality Time", "Quantum Love", "Quantum Odyssey", "Quantum of Solace", "Quantum Quasar", "Quay", "Radiant Reminiscence", "Radiant Reverie", "Raging Bull", "Raiders of the Lost Ark", "Rain Man", "Raise the Red Lantern", "Ran", "Rashomon", "Rebel Without a Cause", "Reservoir Dogs", "Rushmore", "Saving Private Ryan", "Schindlers List", "Selma", "Seven Samurai", "Shutter Island", "Silver Linings Playbook", "Slumdog Millionaire", "Solstice Symphony", "Somewhere", "Southland Tales", "Spartacus", "Spirited Away", "Star Wars A New Hope", "Stardust Sonata", "Stellar Serenity", "Summer Wars", "Sunset Boulevard", "Sunshine Cleaning", "Taxi Driver", "The Artist", "The Avengers", "The Big Lebowski", "The Big Sick", "The Big Sleep", "The Bling Ring", "The Box", "The Boy and the Beast", "The Grandmaster", "The Great Escape", "The Great Gatsby", "The Green Book", "The Green Mile", "The Hidden Fortress", "The Hurt Locker", "The Imitation Game", "The Irishman", "The Kings Speech", "The Last Samurai", "The Life Aquatic with Steve Zissou", "The Life of Pi", "The Lion King", "The Lord of the Rings The Fellowship of the Ring", "The Maltese Falcon", "The Martian", "The Matrix", "The Namesake", "The Patriot", "The Pianist", "The Post", "The Prestige", "The Princess Bride", "The Red Turtle", "The Revenant", "The Royal Tenenbaums", "The Shape of Water", "The Shawshank Redemption", "The Shining", "The Silence of the Lambs", "The Sixth Sense", "The Social Network", "The Tale of the Princess Kaguya", "The Terminator", "The Theory of Everything", "The Truman Show", "The Untouchables", "The Usual Suspects", "The Virgin Suicides", "The Wind Rises", "The Wizard of Oz", "There Will Be Blood", "Thor Ragnarok", "Three Billboards Outside Ebbing, Missouri", "Throne of Blood", "Titanic", "To Kill a Mockingbird", "To Live", "Tokyo Godfathers", "Tokyo Story", "Troy", "Twelve Angry Men", "Twelve Years a Slave", "Valentine's Day", "Valerian and the City of a Thousand Planets", "Van Helsing", "Venom", "Vertigo", "V for Vendetta", "Weathering with You", "What We Do in the Shadows", "Whiplash", "Whisper of the Heart", "Whispers in the Shadows", "Wolf Children", "Year One", "Yellow Rose", "Yojimbo", "Young Adam", "You People", "Your Name"
    };
    ...
    public static List<Movie> setUpSearchDummyMovies(int length) {
        ...
        Log.d(TAG, "search list length: " + titles.length);
